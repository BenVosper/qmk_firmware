...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_MA] = LAYOUT_iso(
    ...
    KC_MPLY,  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          KC_HOME,
    ...
    KC_F16,   KC_LCTL,  KC_LGUI, KC_LALT,                            KC_SPC,                    MO(_FN), KC_LALT, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_FN] = LAYOUT_iso(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_GRV,  _______, _______, _______,
